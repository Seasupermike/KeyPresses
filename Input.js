  ...
  value: (function () {
    class Key {
      ...
      onPress(func) {
        if (typeof func != "function")
          throw TypeError(
            `onPress expected a function, received a ${typeof func}`
          );
      ...
      onRelease(func) {
        if (typeof func != "function")
          throw TypeError(
            `onRelease expected a function, received a ${typeof func}`
          );
    ...
    class anyKey {
      ...
      release(k) {
        ...
        this.pressed = (this.#keysPressed.size > 0); 
        for (const func of this.#onReleaseFuncs) {
          func(k);
        }
      }
